...
class CreateCommand extends MakeForm
{
    protected $signature = 'tall:form-create
    {--template= : nome para o component de tall-form create}';

    protected $description = 'Faça um componente de TAll FORM CREATE para um modelo';
    protected $formName = 'CreateComponent';
     /**
     * @throws Exception
     */
    public function handle(): void
    {
        $folderName       = $this->ask('Qual é o nome da pasta onde será criado seu TALL FORM CREATE (E.g., <comment>Users</comment>)?, Resultado sera <comment>Users/CreateComponent</comment>');
        ...
        $base_path     = $this->ask('Deseja alterar a pasta raiz do component Tall Table (Ex:, <comment>Admin</comment>)?, Resultado sera <comment>Admin/'.$folderName.'/CreateComponent</comment>');
